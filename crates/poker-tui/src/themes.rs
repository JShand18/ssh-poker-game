//! Casino-themed styling and color palettes using owo-colors
//! 
...
#[derive(Debug, Clone)]
pub struct CasinoPalette {
    // Primary colors for casino theme
    pub primary: Color,
    pub secondary: Color,
    pub accent: Color,
...
impl Default for CasinoPalette {
    fn default() -> Self {
        Self {
...
#[derive(Debug, Clone)]
pub struct CasinoStyles {
    pub palette: CasinoPalette,
}

impl CasinoStyles {
    pub fn new() -> Self {
        Self {
            palette: CasinoPalette::default(),
        }
    }
...
/// Helper function to create casino-style gradient text
...
mod tests {
    ...
    #[test]
    fn test_casino_palette_creation() {
        let palette = CasinoPalette::default();
        assert_eq!(palette.primary, Color::Rgb(139, 69, 19));
    }
    
    #[test]
    fn test_casino_styles_creation() {
