...
impl SecureAuthService {
    ...
    pub async fn authenticate_publickey(&mut self, username: &str, _public_key: &key::PublicKey) -> Result<bool> {
    ...
    fn _verify_public_key(&self, provided_key: &key::PublicKey, stored_key: &Option<String>) -> Result<bool> {
...
mod tests {
    ...
    async fn test_password_hashing() {
        ...
        let auth = SecureAuthService::new(db);
