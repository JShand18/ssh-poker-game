use crate::components::{format_card, get_card_color};
...
const TABLE_WIDTH: u16 = 80;
const TABLE_HEIGHT: u16 = 24;
...
impl PokerTableRenderer {
    ...
    pub fn render_lobby(&self, frame: &mut Frame, area: Rect, tables: &[(uuid::Uuid, String, usize, usize)]) {
        ...
        if tables.is_empty() {
            ...
            for (i, (table_id, name, players, max_players)) in tables.iter().enumerate() {
