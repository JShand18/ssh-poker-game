...
//! 
//! Provides reusable, Charm.sh-style components for the poker game
...
use crate::themes::{CharmStyles, CardSuit};
...
impl Card {
    ...
    pub fn render(&self, styles: &CharmStyles) -> Paragraph {
...
impl PlayerInfo {
    ...
    pub fn render(&self, area: Rect, frame: &mut Frame, styles: &CharmStyles) {
